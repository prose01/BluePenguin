...
@Component({
  ...
  styleUrls: [
    ...
    'assets/chat.component.default.css',
    'assets/themes/chat.theme.default.scss',
    'assets/themes/chat.theme.dark.scss'
  ],
...
export class Chat implements OnInit, OnDestroy, IChatController {
  ...
  private initializeTheme(): void {
    if (this.customTheme) {
      ...
      throw new Error(`Invalid theme configuration for chat. "${this.theme}" is not a valid theme value.`);
    }
  }
